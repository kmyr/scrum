...
function normal(...args) {
    return console.log(assemble.apply(this, args.unshift("White") && args));
}

function attention(...args) {
    return console.log(assemble.apply(this, args.unshift("Yellow") && args));
}

function error(...args) {
    return console.log(assemble.apply(this, args.unshift("Red") && args));
}
